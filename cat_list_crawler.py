...
class MyParser(spider.Parser):
    ...
    def htm_parse(self, priority: int, url: str, keys: dict, deep: int, content: object):
        ...
        cat_list = []
        for h in headers:
            cat_list.append(f'https://www.petstation.jp/{h.a["href"]}')
...
def test_spider():
    ...
    saver = MySaver(save_pipe=open("cat_list.txt", "w"))
    ...
    # 添加起始的url
    web_spider.set_start_url("https://www.petstation.jp/animal_list.php?_search_animal__animal_search__species=2&_search_shop_info__animal_search__shop_address2=9&l1_s=0", priority=0,
